...
var rdthoughts: seq[string] = @[
  ...
  """,
  """
    Au collège, quand jai commencé a faire de la musique, je ne me suis jamais posé la question de **pourquoi** je le faisais. à l'époque, mon dumb ass brain était incapable de se fixer et grind un seul intérêt, genre une passion, un sport (??), une forme d'art, peu importe. Apres des années à essayer de comprendre ce que j'aimais, ce que je voulais faire dans la vie, et comment je voulais le faire, j'ai découvert la musique électronique plutôt par hasard, et j'ai commencé à apprendre assez instinctivement. Jusque là, je n'avais jamais été sérieusement intéressé par le sujet. Ma culture musicale se résumait aux musiques d'intros cinem4D et aux tops nrj12. Cette culture, je l'ai donc forgée avec le temps, en apprenant et en écoutant de nouvelles choses. à partir de ce moment, la musique était devenu le seul centre d'intérêt que j'avais et qui avait comme particularité de ne pas me lasser, donc jai continué. Vers le lycée, au bout de 3/4 années de production, jai simplement réalisé que j'étais arrivé trop loin pour m'arrêter, donc jai voulu m'orienter là dedans.

  """,
  """
    je passerai les détails ici, si vous lisez ça vous savez. Mon obsession après avoir eu mon bac a été de continuer d'apprendre tout ce que je pouvais afin de l'appliquer dans mes propres productions. Le sound design, l'arrangement, le mix, etc.... jai effectivement appris ces choses là, décroché un diplôme, puis, en 2024, DATAMOSH THERAPY est né. 2 ans d'acouphènes et moi qui raconte des trucs dans une façon dont le moi du futur aurait sûrement très honte (c'est le cas). Javais atteint pour la première fois un objectif que je m'étais fixé. Cet album était la concrétisation de tout ce que javais imaginé depuis 2020, quand j'écrivais encore des tracklists avec des songs qui n'existent même pas dans les notes de mon ordi. Avec 4 ans de retard, le plan s'était ENFIN déroulé comme prévu. L'ep est sorti, jai eu des bon retours, le concert nul dans un bar perdu au fond du québec était sûrement la meilleure soirée de ma vie. C'était sincèrement tout ce que je voulais à ce moment. 
  """,
  """
    Une des choses qui m'a poussé à continuer cet album, entre 2022 et 2024 était la reconnaissance. J'allais enfin pouvoir montrer aux gens de quoi je suis capable, qu'est-ce qui me construit, la culture et les références accumulées et ce que je peux faire. DMT était un énorme condensé de moi et mes inspirations. Même si c'était 2 personnes, le fait que ces 2 personnes puisse au moins comprendre ce que j'essaie d'être me suffisait. Me dire que jallais peut etre pouvoir etre dans l'esprit d es gens autrement qu'en étant physiquement devant eux était un moteur assez puissant pour me forcer à continuer. Anyway, pour une raison qui m'est encore inconnue (les gens diront que cest parce que l'album est bien -- ), jai fini par atteindre bien plus de personnes que je ne l'imaginais. et ça m'a beaucoup aidé à l'accepter.  
  """,
  """
    Donc quand on est un artiste, la tradition veut qu'on ne le soit pas seulement pour le temps d'un album, mais que, évidemment, on soit capable de réitérer ce processus plusieurs fois. Ce que ça voulait dire pour moi, maintenant que j'étais dans la cour des grands, c'est: il fallait faire la même chose en mieux, et surtout plus rapidement. Ignorant le fait que DMT m'a pris litteral 2 années pour devenir "écoutable", c'est plutot inocemment que j'ai décidé de me lancer dans la production d'un deuxième album, immédiatement apres le premier (FATAL FIELDS, l'intro du projet a été produite le jour de la sortie de DMT et enregistrée le lendemain). Cest précisément là que la descente aux enfers a commencé. 
  """,
  """
    Jai détesté CHAQUE SECONDE de ce projet, et ce pendant tout le temps de sa conception. C'était objectivement mieux que son prédécesseur, mais mon cerveau nétait pas capable de l'aimer. Pourquoi ? Une des différences entre les deux projets, c'est que le contexte de conception n'était pas le même. J'ai réalisé DMT pendant mes études, javais la tête dans le son en permanence, et quand je rentrais de cours il fallait grind pour pouvoir deliver le projet à temps. Cela a résulté en des sessions très courtes, souvent entre 23h et 3-4h du matin. Le fun de la production venait à courtes doses, donc j'allais paradoxalement plus vite puisque j'avais moins le temps de travailler sur le projet, mais je pouvais aussi gamberger dessus tout le long de la journée. Son successeur , quand à lui, a été réalisé dans un autre contexte: littéralement sans-emploi, donc toute la journée devant l'ordi à composer, enregistrer, mixer, recommencer... Ca aurait pu être un rêve, mais mon cerveau n'est pas capable de se réguler dans si peu de limitations. Donc au lieu de savoir quoi faire et de le faire, je me perdais continuellement sur internet a la recherche d'inspiration, qui n'est jamais venu. En juillet 2025, jai donc pris la décision de mettre le projet en pause. J'avais besoin de voir, faire, vivre autre chose. et c'est là que j'ai découvert strudel.
  """,
  """
  ...
  """,
  """
    La seule fois où javais réellement touché à du code, c'était au lycée. Jai fait un bac STI2D SIN, ce qui m'a permis d'apprendre le très horrible arduino. C'était... une mauvaise expérience que je ne retenterai pour rien au monde, et ça m'a convaincu que la programmation était quelque chose qu'il ne fallait pas que je touche. Puis, en novembre 2025, après ce que j'appellerai une des pires semaines de ma vie, j'ai acheté Risk of Rain 2, dans le seul objectif de chercher de la dopamine pour mon cerveau cassé de l'époque. et c'est LA que je suis tombé dans le rabbit hole.
  """,
  """
    Je nai jamais réellement été un gros joueur. les jeux vidéos sont pour moi bien plus un moyen de passer le temps qu'une passion. C'est un monde qui ne m'a jamais réellement fait vibrer comme la musique pourrait le faire, pour la raison suivante: je n'avais pas le bon angle. Jouer aux jeux vidéos? boring. faire des jeux vidéos? hmmmmm qu... FAIRE DES JEUX VIDEOS??? jy avait jamais pensé et ça sonnait comme une excellente idée???? ce que ror2 m'avait apporté était quelque chose auquel je n'avais jamais pensé: TOUT ce que j'aimais faire était réuni dans un seul media: worldbuilding, dessin (bien que ror2 soit en 3d, ce qui nest pas le cas de son prédécesseur), musique, sound design, il me manquait juste.... les skills de programmation.
  """,
  """
    alors jai installé gamemaker. on m'a dit que c'était un des meilleurs et des plus simples. Jai une aversion pour la plupart des trucs trendy, et j'aime énormément utiliser des choses qui ne sont pas les premières options lorsqu'on s'intéresse à un sujet. unity était trop overwhelming, godot etait trop bizarre, et unreal était trop .... trop. gamemaker était parfait. de novembre à février, jai enchainé les tutoriels, les demos de jeu, l'apprentissage, tout. je comprenais enfin "the joy of programming". c'était juste ce que j'aimais le + faire, à grande échelle: simplement manipuler et organiser des groupes de données dans un ordre qui permettait de construire ce qu'on voulait. Absolument rien à voir avec arduino. c'était des problèmes de logiques à résoudre en permanence, ça m'a réellement animé. Mais j'en voulais plus.
  """,
  """
    mars 2026, j'installe Love2D. Un genre de cousin de gamemaker, dont la différence principale est d'être bien plus minimaliste que ce dernier. La seule chose que Love nous donne, c'est un .exe qui ne fait.... rien. Pour cause? c'est à l'utilisateur de tout programmer. contrairement aux principaux game engines, qui fournissent une interface visuelle ainsi que des systèmes pour rendre la conception de jeu plus simple, love2D et la plupart de ses cousins frameworks (j'y reviens plus tard) nous donne seulement des "librairies", des ensembles de fonctions permettant de dessiner des choses à l'écran. ET j'ai galéré. c'était plaisant, mais jai galéré, parce qu'il fallait tout faire seul. L'avantage de ce genre comparativement aux gros engine est qu'ils nous offrent bien plus de liberté, et nous permettent de faire les choses telles que nous le voulons et non telles que l'engine nous impose. Après avoir pris en main la logique du no engine, j'étais bien plus à l'aise avec la programmation. En revanche, je ressentais le besoin de descendre encore plus bas pour trouver le vrai bonheur. Ce bonheur s'est avéré vivre chez une personne du nom de Raysan5.
  """,
  """
...
proc renderMain(): VNode =
  buildHtml(tdiv(class = "myclass")):
    ...
    h4:
      text "pourquoi le teleglitch est le meilleur jeu de tous les temps"

    p:
      text "parce que cest le meilleur jeu de tous les temps"
